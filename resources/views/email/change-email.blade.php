                    ...
                    <div class="card card-auth p-4">
                        <div class="card-body">
                            <div class="mb-4 text-center">
                                <h3 class="fw-bold">Cambio de correo electrónico</h3>
                                <p class="text-muted">Ingresa tu nuevo correo electrónico y contraseña actual</p>
                            </div>
                            <form action="{{ route('email.update') }}" method="post" id="registerForm">
                                @csrf
                                <div class="mb-3">
                                    <label for="email" class="form-label">
                                        <i class="bi bi-envelope-fill me-1"></i>Nuevo correo electrónico
                                    </label>
                                ...
                                <div class="d-grid gap-2 mt-4">
                                    <button type="submit" class="btn btn-success btn-auth">
                                        <i class="bi bi-send me-2"></i>Enviar codigo de verificación
                                    </button>
                                </div>
                            </form>
                            <hr class="my-4">
